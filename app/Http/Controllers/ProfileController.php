...
class ProfileController extends Controller
{
    ...
    public function updateProfile(Request $request)
    {
        ...
        try {
            ...
            $fields = $this->validateProfileFields($request, $user);
            ...
            $updateData = $this->prepareProfileUpdateData($request, $fields);
    ...
    private function validateProfileFields(Request $request, $user)
    {
    ...
    private function prepareProfileUpdateData(Request $request, $fields)
    {
        $updateData = [];
