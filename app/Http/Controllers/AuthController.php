...
class AuthController extends Controller
{
    ...
    public function update(Request $request){ 
        ...
        try {
            ...
            // Update the user record for the provided fields if they are present in the request
            $updateData = [];
            ...
            // Update the user record if there are any changes
            if (!empty($updateData)) {
            ...
            // Check if name, phone_number, email, or password field has errors
